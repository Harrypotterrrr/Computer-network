...
int main(){
    ...
    std::cout << strlen(buffer) + 1 << " bytes, test2-5-1 have recieved" << std::endl;
    std::cout << buffer << "#, is test2-5-1 recieved" <<std::endl;
    ...
    std::cout << strlen(buffer) + 1 << " bytes, test2-5-1 have sent" << std::endl;
    std::cout << buffer << "#, is test2-5-1 sent" <<std::endl;
    close(pipe_fd);
